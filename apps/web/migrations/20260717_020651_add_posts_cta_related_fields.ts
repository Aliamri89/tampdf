...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "posts" ADD COLUMN "related_tool" "enum_posts_related_tool";
  ALTER TABLE "posts_locales" ADD COLUMN "excerpt" varchar;
  ALTER TABLE "posts_locales" ADD COLUMN "cta_heading" varchar;
  ALTER TABLE "posts_locales" ADD COLUMN "cta_body" varchar;
  ALTER TABLE "posts_locales" ADD COLUMN "cta_button_label" varchar;
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "posts" DROP COLUMN "related_tool";
  ALTER TABLE "posts_locales" DROP COLUMN "excerpt";
  ALTER TABLE "posts_locales" DROP COLUMN "cta_heading";
  ALTER TABLE "posts_locales" DROP COLUMN "cta_body";
  ALTER TABLE "posts_locales" DROP COLUMN "cta_button_label";
